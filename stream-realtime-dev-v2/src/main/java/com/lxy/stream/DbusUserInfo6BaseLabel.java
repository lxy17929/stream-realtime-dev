...
import com.lxy.stream.function.*;
...
/**
 * @Package com.lxy.stream.DbusUserInfo6BaseLabel
 * @Author xinyu.luo
 * @Date 2025/5/15 21:56
 * @description: DbusUserInfo6BaseLabel
 */
public class DbusUserInfo6BaseLabel {
    ...
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<String> kafkaCdcDbSource = env.fromSource(
                FlinkSourceUtil.getKafkaSource("ods_user_profile", "kafka_source_user_profile"),
        ...
        */
        ...
        /*processIntervalJoinUserInfo6BaseMessageDs.map(data -> data.toJSONString())
                .sinkTo(
                        FlinkSinkUtil.getKafkaSink("dwd_user_info_label")
                );

        mapOrderInfoAndDetailModelDs.map(data -> data.toJSONString())
                .sinkTo(
                        FlinkSinkUtil.getKafkaSink("dwd_order_info_base_label")
                );

        mapDeviceAndSearchRateResultDs.map(data -> data.toJSONString())
                .sinkTo(
                        FlinkSinkUtil.getKafkaSink("dwd_page_info_base_lebel")
                );*/
